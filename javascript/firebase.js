...
export const setOrder = (
  ...
  addDoc(collection(db, "ordenes_compra"), {
    nombre: name,
    apellido: apellido,
    localidad: localidad,
...
export const upudate_stok = (id, stock_final) =>
  updateDoc(doc(db, "stock_calzado", id), { stock: stock_final });

export const onGetStock = (callback) =>
  onSnapshot(collection(db, "stock_calzado"), callback);
